 ...
 * >here</a>
 * 
 * 使用Spring+Maven配置Netty4<a>http://my.oschina.net/boomya/blog/139464</a>
 * 
 * 为了创建一个netty服务端, 通常我们需要以下几个步骤:
 *   1.创建ServerBootstrap对象
 *   2.设置参数像bossGroup, workerGroup, childHandler以及设置ChannelOption就像keep_alive针对bootstrap.
 *   3.使用bootstrap创建channel.
 *   4.确保可以退出程序, 你调用shutDownGracefully方法或者相似的方法.
 * 
 */
@Configuration
@ComponentScan("com.hb.netty")
@PropertySource("classpath:netty/netty-server.properties")
...
//	private String log4jConfiguration;
	...
	private com.hb.netty.handlers.StringProtocolInitalizer protocolInitalizer;
