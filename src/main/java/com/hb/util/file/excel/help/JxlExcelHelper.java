/**  
 * @Title: JxlExcelHelper.java 
 * @Package com.hb.util.file.excel.help 
 * @Description: TODO(用一句话描述该文件做什么) 
 * @author huangbing 
 * @date 2015年5月19日 上午8:53:15 
 * @version V1.0  
 */ 
package com.hb.util.file.excel.help;

/** 
 * http://www.oschina.net/code/snippet_1021818_47870
 ...
 * 基于JXL实现的Excel工具类
 * 
 * 通过java反射自动将对象列表写入excel文件和读出excel数据封装成对象列表，类似序列化和反序列化机制，支持对象属性过滤和Label重命名，后续还会改进。
        类结构：抽象工具类ExcelHelper， 实现类JxlExcelHelper, HssfExcelHelper, XssfExcelHelper分别继承ExcelHelper，其中JxlExcelHelper通过JXL处理excel2003文档，HssfExcelHelper和XssfExcelHelper通过POI分别处理excel2003和excel2007文档。
        依赖的jar包：jxl.jar, poi-3.10.1.jar, poi-ooxml-3.10.1.jar, poi-ooxml-schemas-3.10.1.jar
 * 
 * @author liujiduo
 * 
 */
